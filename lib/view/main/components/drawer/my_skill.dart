...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Java',image: 'assets/icons/java2.png',),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Provoider',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'javascript',image: 'assets/icons/javascript.png',),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'React-js',image: 'assets/icons/react.png',),
      ],);
  }
}
