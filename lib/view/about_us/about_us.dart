                  ...
                  children: [
                    ...
                    isSmallScreen
                        ...
                        : Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Left side - About content and services
                              Expanded(
                                flex: 2,
                                child: Column(
                                  children: [
      ...
      children: [
        ...
        Column(
          children: [
            ...
            _buildStatCard(
              controller.clientSatisfaction,
              controller.statistics[1],
            ),
            const SizedBox(height: 20),
            _buildStatCard(
              controller.yearsExperience,
              controller.statistics[2],
            ),
          ],
        ),
        const SizedBox(height: 24),
  ...
  Widget _buildStatCard(RxInt value, Statistic stat) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: stat.accentColor.withOpacity(0.3),
          width: 1,
        ),
      ),
      child: Column(
